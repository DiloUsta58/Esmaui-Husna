           ...
           const Duration = document.getElementById("Duration");
            //GanzeSekunden----------------------------------
           const GanzeSekunden = document.getElementById("GanzeSekunden");
            //GanzeSekunden----------------------------------
           const NameOfAllah = document.getElementById("NameOfAllah");
           const Arap = document.getElementById("Arap");
        ...
        function butText() {
            ...
            const timestamps = {
                ...
                "01:42": { header: "Al Jabbar الْجَبَّارُ", track: "track10" },
                ...
                "02:40": { header: "Al Gaffar الْغَفَّارُ", track: "track15" },
                ...
                "04:25": { header: "Ar Rafi الرَّافِعُ", track: "track24" },
       ...
       // Zeiten und zugehörige Bilder
        ...
        const timeAnlamı = [
            ...
            { time: 801, text: "[ ilediği gibi tasarruf eden, her şeyi kolayca yaratan kudret sahibi. ]" },
        ...
        const timeSureler = [
            ...
            { time: 1152, text: "[ 1:1, 3:18, 5:109, 6:124, 7:180, 8:40, 16:91, 20:8, 57:5, 65:3, 74:56, 85:20 ]" }
        ];  
        ...
        let currentSpanIndexS = 0;
            ...
            Duration.textContent =  ` - ${audioDuration}`;
            //GanzeSekunden.textContent = `${currentTime1}`;
